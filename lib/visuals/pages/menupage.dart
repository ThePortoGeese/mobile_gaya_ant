...
class _MenuPageState extends State<MenuPage> {
  ...
  Widget? currentIcon = Image.asset(
    'assets/ptlang.png',
    width: 24,
    height: 24,
    fit: BoxFit.contain,
    ...
    switch (bts) {
      case BTState.errorBonding:
        if (loadingPopUp) {
          ...
          await showDialog<void>(
            ...
            builder: (context) => Normalalert(
              titleText: AppLocalizations.of(context)!.bondingError,
              bodyText: AppLocalizations.of(context)!.bondingErrorMessage,
      ...
      case BTState.errorConnection:
        if (loadingPopUp) {
          ...
          await showDialog<void>(
            ...
            barrierDismissible: false,
            builder: (context) => Normalalert(
              titleText: AppLocalizations.of(context)!.connectionError,
              bodyText: AppLocalizations.of(context)!.connectionErrorMessage,
              titleStyle: alertTitleStyle,
            ),
          );
          popUp = false;
      ...
      case BTState.errorPermission2:
        if (!popUp) {
          ...
          await showDialog<void>(
            ...
            barrierDismissible: false,
            builder: (context) => Normalalert(
              titleText: AppLocalizations.of(context)!.permissionsError,
              bodyText: AppLocalizations.of(context)!.permissionsErrorMessage,
              titleStyle: alertTitleStyle,
            ),
          );
          popUp = false;
        ...
        showDialog<void>(
          ...
          builder: (context) {
            return CircularLoading(
              loadingText: AppLocalizations.of(context)!.connectingToDevice,
            );
          },
        );
      case BTState.startSearch:
        ...
        showDialog(
          ...
          builder: (context) {
            return CircularLoading(
              loadingText: AppLocalizations.of(context)!.searchingDevices,
            );
          },
        );
      ...
      case BTState.notAvailable:
        await showDialog<void>(
          ...
          barrierDismissible: false,
          builder: (context) => Normalalert(
            titleText: AppLocalizations.of(context)!.bluetoothError,
            bodyText: AppLocalizations.of(
              context,
            )!.bluetoothNotAvailableMessage,
            titleStyle: alertTitleStyle,
          ),
        );
        exit(0);
  ...
  Widget build(BuildContext context) {
    ...
    String? changeLanguage =
        context.watch<LocaleNotifer>().locale?.languageCode ?? 'en';
  ...
  void handleDisconnectButtonPressed() async {
    context.read<BluetoothModule>().sendBytes(
  ...
  void handleDeviceTap(String mac) async {
    ...
    if (await context.read<BluetoothModule>().connectToDevice(mac, pin) ==
        FunctionState.failure) {
      return;
    }
