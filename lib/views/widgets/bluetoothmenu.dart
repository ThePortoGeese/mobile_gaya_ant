        ...
        children: [
          ...
          ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: (deviceConnected ? Color(0xffDB3B3E) : Color(0xff194B97)),
            ...
            onPressed:(bluetoothButtonEnabled ? (deviceConnected? onDisconnectPressed : onConnectPressed) : null),
            ...
            child: Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  final mac   = devices.keys.elementAt(index);
                  return DeviceListItem(value: devices[mac]!, onDeviceTap: () => onDeviceTap(mac));
                } 
                ),
              ),
            ),
